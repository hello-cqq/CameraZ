...
import com.ahahahq.barcode.zxing.ZXingDecoder
import com.ahahahq.barcode.zxing.ZXingGenerator

internal class CodecFactory {

    fun getDecoder(): BarcodeDecoder {
        return ZXingDecoder()
    }

    fun getCodeGenerator(): BarcodeGenerator {
        return ZXingGenerator()
    }
}